...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (dataLokal) {
        ...
        semuaTugas = [
            { namaTugas: "Mengupload kode ke github", kategori: "Kuliah", prioritas: "tinggi", tenggat: "2026-08-06", status: "belum", catatan: "Pelajari ulang materi" },
            { namaTugas: "Membuat laprak", kategori: "Kuliah", prioritas: "tinggi", tenggat: "2026-09-06", status: "belum", catatan: "Cari sumber yang valid" },
            { namaTugas: "Antar Laundry", kategori: "Pribadi", prioritas: "sedang", tenggat: "", status: "selesai", catatan: "Cek semua pakaian kotor" }
        ];
        simpanData();
    }
